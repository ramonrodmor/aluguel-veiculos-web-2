...
//	}
	...
	public List<Veiculo> getBusca(String chave) {
		try {
			List<Veiculo> veiculos = new ArrayList<Veiculo>();
			PreparedStatement stmt = this.connection.prepareStatement("select * from veiculos where renavan=?");
	...
	public List<Veiculo> getBuscaTipo(String chave) {
		try {
			List<Veiculo> veiculos = new ArrayList<Veiculo>();
			PreparedStatement stmt = this.connection.prepareStatement("select * from veiculos where categoria=?");
